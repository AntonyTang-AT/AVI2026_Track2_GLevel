# 本机仅推理 + 导出 submission（路径同 vote_train_glevel_local.ps1）
#   powershell -ExecutionPolicy Bypass -File .\vote_test_glevel_local.ps1
...
$outCsv = if ($env:TEST_OUTPUT_CSV) { $env:TEST_OUTPUT_CSV } else { "submission_glevel.csv" }
