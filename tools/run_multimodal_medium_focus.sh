...
# 在 scripts/glevel_train_multimodal.sh 基线上追加；仍须与官方或 train_fixed 路径等自行 export 一致。
set -eu
...
export TEST_OUTPUT_CSV="${TEST_OUTPUT_CSV:-${_ROOT}/reports/submissions/submission_glevel_multimodal_medium_focus.csv}"
